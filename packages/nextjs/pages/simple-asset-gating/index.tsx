...
import { signBirthYear } from "../zero-gating/AssetHoldingSignature";
import { parseForm } from "../zero-gating/GenerateProof";
...
const ExampleUI: NextPage = () => {
  ...
  const start = async () => {
    return signBirthYear({
      ...
      quantity: 1,
      AssetAddress: "0x59c6995e998f97a5a0044966f0945389dc9e86dae88c7a8412f4603b6b78690d",
    })
      .then(result => {
        console.log(result);
        ...
        return generateProof("AssetGating", parsedForm as ParsedArgs);
      })
      .then(result => {
